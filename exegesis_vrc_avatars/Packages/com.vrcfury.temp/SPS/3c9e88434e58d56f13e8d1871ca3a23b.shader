Shader "Hidden/Locked/SPSPatched/3c9e88434e58d56f13e8d1871ca3a23b"
{
	Properties
	{
[Header(SPS)]
...
#pragma vertex spsVert
			...
			void applyPathing(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				if (poiMods.audioLinkAvailable)
				{
					...
					if (1.0)
					{
						alTimeOffsets.x += AudioLinkGetChronoTime(4.0, 1.0) * 0.0;
						alTimeOffsets.y += AudioLinkGetChronoTime(0.0, 0.0) * 0.0;
						alTimeOffsets.z += AudioLinkGetChronoTime(2.0, 1.0) * 0.01;
						alTimeOffsets.w += AudioLinkGetChronoTime(0.0, 0.0) * 0.0;
					}
					if (1.0)
					{
