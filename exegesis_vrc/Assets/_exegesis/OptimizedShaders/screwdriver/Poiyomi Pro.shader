Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/90a815eda3606e0458f109053e925980"
{
	Properties
	{
		[HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi 9.3.37</color>", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				#ifdef _LIGHTINGMODE_TEXTURERAMP
				float2 rampUVs = poiLight.lightMap + 0.5;
				if (1 > 1)
				{
					rampUVs.y = (floor(poiMesh.uv[1].y * 1) + 0.5) / 1;
				}
